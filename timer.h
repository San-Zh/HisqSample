...
inline double timer::use_usec()
{
    ...
    return (double) (t_end.tv_sec - t_begin.tv_sec) * 1.0e+6 + (double) (t_end.tv_usec - t_begin.tv_usec);
}

inline double timer::use_sec()
{
    gettimeofday(&t_end, NULL);
    return (double) (t_end.tv_sec - t_begin.tv_sec) + (double) (t_end.tv_usec - t_begin.tv_usec) * 1.0e-6;
}